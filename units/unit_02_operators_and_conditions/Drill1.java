...
public class Drill1 {
	...
	public static void main(String[] args) {
		...
		System.out.printf("The initial salary is %d and the net is %d.\nDetails of reductions:\n"
				...
				taxReduction, isEntitledForTaxRelief ? "" : "not ", socialSecurityReduction, pensionFundReduction,
				educationFundReduction, mealsIrregularityReduction > 0
						? "Meals Irregularity Reduction: " + mealsIrregularityReduction : "No meals reduction");
	}
}